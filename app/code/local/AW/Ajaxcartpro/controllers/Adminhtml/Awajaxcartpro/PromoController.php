...
class AW_Ajaxcartpro_Adminhtml_Awajaxcartpro_PromoController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initPromo()
    {
        ...
        $promoModel->getConditions()->setJsFormObject('rule_conditions_fieldset');
