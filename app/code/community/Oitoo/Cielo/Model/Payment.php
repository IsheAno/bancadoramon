...
class Oitoo_Cielo_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    ...
    public function assignData($data)
    {
        ...
        $info->setCcType($data->getBandeiraCielo())
            ...
            ->setCcNumberEnc($info->encrypt(str_replace(' ', '',$data->getNumeroCartaoCielo()))) //criptografa o numero do cartão
        ;
    ...
    public function validate() {
		...
		Mage::log(Mage::helper('apelidocielo')->validateCcNum($ccNumber). " " . $ccNumber . " " . $bandeira);
