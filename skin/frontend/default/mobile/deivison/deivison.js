...
/*===================================================== End Click ===========================================================*/
            ...
            */
            ...
            $j('input').click( function(){
                    $j('html head').find('title').text(  "Adaptive Shop"  );
                    _gaq.push(['_trackPageview', '#' + $j(this).attr('name') + '']);
            });

            $j(':input').blur( function(){
                    pageTracker._trackEvent("Adaptive Shop", "input_exit", $j(this).attr('name'));
            });
...
$j(function($) {
      ...
      $j('input[name*="shipping_method"]').live('click', function() {
             ...
             $j('html head').find('title').text(  "Adaptive Shop"  );
              ...
              pageTracker._trackEvent("Adaptive Shop", "input_exit", $j(this).attr('value'));
      });
