...
var simplegoogleshopping = {
    ...
    checkLibrary: function () {
        ...
        // mise Ã  jour des textarea si mode text
        new Ajax.Request(
                url, {
    ...
    switchSize: function () {
        ...
        if ($('dfm-console').hasClassName('reduce')) {
            ...
            simplegoogleshopping.storage.top = $('dfm-console').getStyle('top');
            simplegoogleshopping.storage.left = $('dfm-console').getStyle('left');
    ...
    checkSyntax: function () {
        ...
        simplegoogleshopping.enligthSyntax();
    },
